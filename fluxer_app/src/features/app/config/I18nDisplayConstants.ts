...
export const SUPPORT_EMAIL = 'admin@porch.chat';
...
export const FLUXER_TAG_LABEL = 'PorchTag';
...
export const EXAMPLE_INSTANCE_DOMAIN = 'api.porch.chat';
export const LINK_PREVIEW_EXAMPLE_URL = 'https://porch.chat';
