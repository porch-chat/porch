...
const CONFIG: Config = {
	families: {
		...
		brand: {hue: 174, saturation: 72, useSaturationFactor: true},
...
hsl(258, calc(10% * var(--saturation-factor)), 2%) 20%
			...
			{name: '--brand-primary', family: 'brand', lightness: 30},
			{name: '--brand-secondary', family: 'brand', saturation: 68, lightness: 28},
			{name: '--brand-primary-light', family: 'brand', saturation: 68, lightness: 72},
