...
import {
	DEFAULT_EMAIL_TEMPLATE_BRANDING,
	type EmailTemplateBranding,
	getEmailTemplate,
} from '@pkgs/email/src/email_i18n/EmailI18n';
...
export class EmailI18nService implements IEmailI18nService {
	private readonly branding: EmailTemplateBranding;

	constructor(branding: EmailTemplateBranding = DEFAULT_EMAIL_TEMPLATE_BRANDING) {
	...
	getTemplate<T extends EmailTemplateKey>(
		...
		return getEmailTemplate(templateKey, locale, variables, this.branding);
	}
}
