...
class RequestServices implements RequestScopedServices {
	...
	private cachedPorchHubService: PorchHubService | undefined;
	...
	get porchHubService(): PorchHubService {
		this.cachedPorchHubService ??= new PorchHubService(
			getInstanceConfigRepository(),
			this.guildService.members,
			getUserRepository(),
		);
		return this.cachedPorchHubService;
	}
